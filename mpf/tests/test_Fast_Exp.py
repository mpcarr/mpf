...
class TestFastExp(TestFastBase):
    ...
    def create_expected_commands(self):
        ...
        self.serial_connections['exp'].expected_commands = {
            ...
            'RA@880:000000': '',
            'ER@880:0,0,0,20': 'ER:P',
            'ER@880:1,0,20,20': 'ER:P',
            'ER@880:2,0,40,20': 'ER:P',
            'ER@880:3,0,60,20': 'ER:P',

            'RA@881:000000': '',
            'ER@881:0,0,0,20': 'ER:P',
            'ER@881:1,0,20,20': 'ER:P',
            'ER@881:2,0,40,20': 'ER:P',
            'ER@881:3,0,60,20': 'ER:P',

            'RA@882:000000': '',
            'ER@882:0,0,0,20': 'ER:P',
            'ER@882:1,0,20,20': 'ER:P',
            'ER@882:2,0,40,20': 'ER:P',
            'ER@882:3,0,60,20': 'ER:P',

            # set all lights off on secondary 0091
            'RA@890:000000': '',
            'ER@890:0,0,0,20': 'ER:P',
            'ER@890:1,0,20,20': 'ER:P',
            'ER@890:2,0,40,20': 'ER:P',
            'ER@890:3,0,60,20': 'ER:P',

            'RA@892:000000': '',
            'ER@892:0,0,0,20': 'ER:P',
            'ER@892:1,0,20,20': 'ER:P',
            'ER@892:2,0,40,20': 'ER:P',
            'ER@892:3,0,60,20': 'ER:P',

            # set all lights off on 0071
            'RA@B40:000000': '',
            'ER@B40:0,0,0,20': 'ER:P',
            'ER@B40:1,0,20,20': 'ER:P',
            'ER@B40:2,0,40,20': 'ER:P',
            'ER@B40:3,0,60,20': 'ER:P',

            # set all lights off on 0081
            'RA@840:000000': '',
            'ER@840:0,0,0,20': 'ER:P',
            'ER@840:1,0,20,20': 'ER:P',
            'ER@840:2,0,40,20': 'ER:P',
            'ER@840:3,0,60,20': 'ER:P',
            'RA@841:000000': '',
            'ER@841:0,0,0,20': 'ER:P',
            ...
            'RA@480:000000': '',
            'ER@480:0,0,0,20': 'ER:P',
            'ER@480:1,0,20,20': 'ER:P',
            'ER@480:2,0,40,20': 'ER:P',
            'ER@480:3,0,60,20': 'ER:P',
            'RA@481:000000': '',
            'ER@481:0,0,0,20': 'ER:P',
            'ER@481:1,0,20,20': 'ER:P',
            'ER@481:2,0,40,20': 'ER:P',
            'ER@481:3,0,60,20': 'ER:P',
            'RA@482:000000': '',
            'ER@482:0,0,0,20': 'ER:P',
            'ER@482:1,0,20,20': 'ER:P',
            'ER@482:2,0,40,20': 'ER:P',
            'ER@482:3,0,60,20': 'ER:P',
