...
class LightGroup(SystemWideDevice):
    ...
    def _reorder_lights(self):
        ...
        print(self.machine.hardware_platforms)
        ...
        if self.config['size'] == '8digit':
            ...
            order = [
                    95, 91, 94, 81, 84, 89, 86, 90, 87, 88, 82, 92, 83, 85, 93,
                    104, 75, 78, 97, 100, 102, 99, 77, 103, 101, 76, 79, 96, 98, 80,

                    110, 106, 109, 66, 69, 74, 71, 105, 72, 73, 67, 107, 68, 70, 108,
                    119, 60, 63, 112, 115, 117, 114, 62, 118, 116, 61, 64, 111, 113, 65,

                    5, 1, 4, 51, 54, 59, 56, 0, 57, 58, 52, 2, 53, 55, 3,
                    14, 45, 48, 7, 10, 12, 9, 47, 13, 11, 46, 49, 6, 8, 50,

                    20, 16, 19, 36, 39, 44, 41, 15, 42, 43, 37, 17, 38, 40, 18,
                    29, 30, 33, 22, 25, 27, 24, 32, 28, 26, 31, 34, 21, 23, 35]
            ...
            order = [5, 1, 4, 21, 24, 29, 26, 0, 27, 28, 22, 2, 23, 25, 3,
                    14, 15, 18, 7, 10, 12, 9, 17, 13, 11, 16, 19, 6, 8, 20]
        else:
